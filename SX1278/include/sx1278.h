...
#ifndef LORA_SX1278_SX1278_H_
#define LORA_SX1278_SX1278_H_
...
typedef enum {
  ...
  RFLR_STATE_CAD_INIT_SE,
  RFLR_STATE_CAD_RUNNING_SE,
  RFLR_STATE_CAD_INIT_TH,
  RFLR_STATE_CAD_RUNNING_TH
} tRFLRStates;
